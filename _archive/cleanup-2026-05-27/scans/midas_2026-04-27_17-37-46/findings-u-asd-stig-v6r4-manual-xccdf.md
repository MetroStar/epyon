...
Evidence:
- Static repository review completed on 2026-04-27.
- The application uses httpx and uvicorn/starlette for HTTP client/server functionality (pyproject.toml dependencies).
- No explicit enforcement of DoD-approved encryption (e.g., TLS configuration) is present in the provided code or configuration.
- Control-specific implementation evidence was not demonstrably satisfied from repository artifacts alone; disposition set to Open pending system-level validation and artifact collection.
...
- Static repository review completed on 2026-04-27.
- The application uses httpx and uvicorn/starlette for HTTP client/server functionality (pyproject.toml dependencies).
- No explicit enforcement of cryptographic integrity mechanisms (e.g., TLS configuration) is present in the provided code or configuration.
- Control-specific implementation evidence was not demonstrably satisfied from repository artifacts alone; disposition set to Open pending system-level validation and artifact collection.
...
Evidence:
- Static repository review completed on 2026-04-27.
- No SOAP message handling or WS-Security/SAML assertion logic is present in the provided source code or dependencies.
- The application does not utilize SOAP messages; this check is not applicable.
...
Evidence:
- Static repository review completed on 2026-04-27.
- No SOAP or WS-Security token handling is present in the provided source code or dependencies.
- The application does not utilize WS-Security tokens; this check is not applicable.
...
Evidence:
- Static repository review completed on 2026-04-27.
- No use of WS-Security or SAML assertions is present in the provided source code or dependencies.
- The application does not utilize WS-Security or SAML assertions; this requirement is not applicable.
...
Evidence:
- Static repository review completed on 2026-04-27.
- No SAML assertion handling is present in the provided source code or dependencies.
- The application does not utilize SAML assertions; this check is not applicable.
...
Evidence:
- Static repository review completed on 2026-04-27.
- No WS-Security token handling is present in the provided source code or dependencies.
- The application does not utilize WS-Security tokens; this check is not applicable.
...
Evidence:
- Static repository review completed on 2026-04-27.
- No OS-level user/group or file permission assignments are present in the repository.
- Application privilege separation and enforcement cannot be confirmed from static code or configuration alone.
...
Evidence:
- Static repository review completed on 2026-04-27.
- No evidence of application runtime account or database privilege configuration is present in the repository.
- OS/database privilege assignments require system-level inspection.
...
Evidence:
- Static repository review completed on 2026-04-27.
- No static evidence of privileged function audit logging is present in the supplied codebase.
- Logging of privileged actions requires dynamic review of application log output and code paths.
...
Evidence:
- Static repository review completed on 2026-04-27.
- No authentication or account lockout logic is present in the supplied source code.
- Enforcement of invalid logon attempt limits requires review of authentication implementation.
...
Evidence:
- Static repository review completed on 2026-04-27.
- No user account management or unlock process is present in the supplied source code.
- Unlock process and administrative procedures require policy and operational artifact review.
...
Evidence:
- Static repository review completed on 2026-04-27.
- No user interface or login banner implementation is present in the supplied source code.
- Banner display prior to access cannot be confirmed from repository artifacts.
...
Evidence:
- Static repository review completed on 2026-04-27.
- No user interface or login workflow is present in the supplied source code.
- Retention and acknowledgment of the DoD banner requires dynamic UI review.
...
Evidence:
- Static repository review completed on 2026-04-27.
- No evidence of a publicly accessible user interface or DoD banner display is present in the repository.
- Public accessibility and banner display require deployment and UI review.
...
Evidence:
- Static repository review completed on 2026-04-27.
- No user authentication or last logon display logic is present in the supplied source code.
- Display of last successful logon requires review of authentication and UI implementation.
...
Evidence:
- Static repository review completed on 2026-04-27.
- No explicit non-repudiation (e.g., digital signature) functionality is present in the supplied codebase.
- Requirement applicability and implementation must be confirmed via documentation and admin interview.
...
Evidence:
- Static repository review completed on 2026-04-27.
- No log aggregation or audit record compilation functionality is present in the supplied codebase.
- Application does not provide audit record aggregation services.
...
Evidence:
- Static repository review completed on 2026-04-27.
- No session management or session ID creation logic is present in the supplied source code.
- Audit record generation for session ID creation requires review of authentication/session implementation.
...
Evidence:
- Static repository review completed on 2026-04-27.
- No session management or session ID destruction logic is present in the supplied source code.
- Audit record generation for session ID destruction requires review of authentication/session implementation.
...
Evidence:
- Static repository review completed on 2026-04-27.
- No session renewal or privilege escalation logic is present in the supplied source code.
- Audit record generation for session ID renewal requires review of authentication/session implementation.
...
Evidence:
- Static repository review completed on 2026-04-27.
- No application logging implementation is present in the supplied codebase that would indicate handling or exclusion of sensitive data.
- Log content and sensitive data handling require review of logging configuration and output.
...
Evidence:
- Static repository review completed on 2026-04-27.
- No session timeout or session activity logging logic is present in the supplied source code.
- Audit record generation for session timeouts requires review of session management implementation.
...
Evidence:
- Static repository review completed on 2026-04-27.
- No application log format or event timestamping logic is present in the supplied codebase.
- Inclusion of event timestamps in logs requires review of logging implementation and output.
...
Evidence:
- Static repository review completed on 2026-04-27.
- No HTTP request/response logging implementation is present in the supplied codebase that would capture HTTP headers.
- Logging of HTTP headers requires review of application logging and request handling.
...
Evidence:
- Static repository review completed on 2026-04-27.
- The SafeHttpClient in security/safe_http_client.py logs and validates outbound HTTP requests, but there is no evidence that destination IP addresses are logged as part of audit records.
- No logging of destination IPs is present in the provided code.
...
Evidence:
- Static repository review completed on 2026-04-27.
- While lib/ingestion/hooks.py includes timestamp handling (e.g., ingested_at), there is no evidence that all audit records or logs produced by the application include date and time information for all events.
- No global logging configuration or enforcement of timestamped audit records is present.
...
Evidence:
- Static repository review completed on 2026-04-27.
- ProvenanceEnricher in lib/ingestion/hooks.py attaches some component metadata to search results, but there is no evidence that all audit records include the triggering component, feature, or function.
- No comprehensive audit logging implementation is visible.
...
Evidence:
- Static repository review completed on 2026-04-27.
- No evidence of centralized logging configuration or unique application identifier inclusion in logs was found in the provided code or configuration.
- pyproject.toml does not specify centralized logging or unique log identifiers.
...
Evidence:
- Static repository review completed on 2026-04-27.
- No evidence that audit records include the outcome of events (e.g., SUCCESS/FAILURE) was found in the provided codebase.
- Logging of operation results is not demonstrated.
...
Evidence:
- Static repository review completed on 2026-04-27.
- No evidence that audit records include user or process identity was found in the provided codebase.
- Logging of user/process identifiers is not demonstrated.
...
Evidence:
- Static repository review completed on 2026-04-27.
- No evidence that privileged command text or individual identities of group account users are logged was found in the provided codebase.
- No privileged command auditing is implemented.
...
Evidence:
- Static repository review completed on 2026-04-27.
- No evidence of transaction recovery logs or transaction-based logging configuration was found in the provided codebase or pyproject.toml.
- No transaction logging implementation is present.
...
Evidence:
- Static repository review completed on 2026-04-27.
- No evidence of centralized management or configuration of audit record content across application components was found in the provided codebase or configuration files.
- No log management interface is present.
...
Evidence:
- Static repository review completed on 2026-04-27.
- No evidence that audit records are off-loaded to a different system or media was found in the provided codebase or configuration.
- No automated log transfer or centralized logging is configured.
...
Evidence:
- Static repository review completed on 2026-04-27.
- No evidence that the application is configured to write logs to a centralized log repository was found in the provided codebase or pyproject.toml.
- Centralized log management is not demonstrated.
...
Evidence:
- Static repository review completed on 2026-04-27.
- No evidence of audit storage capacity monitoring or alerting at 75% utilization was found in the provided codebase or configuration.
- No alarming or notification logic is present.
...
Evidence:
- Static repository review completed on 2026-04-27.
- No evidence of real-time alerting for audit failure events was found in the provided codebase or configuration.
- No audit failure detection or alerting logic is present.
...
Evidence:
- Static repository review completed on 2026-04-27.
- No evidence of alerting the ISSO and SA in the event of audit processing failure was found in the provided codebase or configuration.
- No audit failure alarming is implemented.
...
Evidence:
- Static repository review completed on 2026-04-27.
- No evidence that the application is configured to shut down or take compensating action upon audit failure was found in the provided codebase or configuration.
- No audit failure handling logic is present.
...
Evidence:
- Static repository review completed on 2026-04-27.
- No evidence that the application provides centralized review and analysis of audit records from multiple components was found in the provided codebase or configuration.
- No log aggregation or review interface is present.
...
Evidence:
- Static repository review completed on 2026-04-27.
- No separate audit tools (executables or libraries for log manipulation) are present in the repository; the application is a Python library/module, not a standalone application with external audit tooling.
...
Evidence:
- Static repository review completed on 2026-04-27.
- No separate audit tools are provided by the application; there are no file-based log viewers or manipulators in the codebase.
...
Evidence:
- Static repository review completed on 2026-04-27.
- No code or configuration enables user-driven installation of software, plugins, or extensions; pyproject.toml and source code do not expose any user-facing install/extension mechanism.
...
Evidence:
- Static repository review completed on 2026-04-27.
- No explicit file permission or RBAC enforcement for library directories is present in the repository; enforcement of file system permissions is not statically verifiable from code alone.
...
Evidence:
- Static repository review completed on 2026-04-27.
- Vulnerability assessment process and scan results are not present in the repository; this control requires organizational process and artifact review.
...
Evidence:
- Static repository review completed on 2026-04-27.
- No static enforcement of organizational program execution policies is present in the codebase; enforcement is likely external or policy-driven.
...
Evidence:
- Static repository review completed on 2026-04-27.
- The application is not a configuration management or system process management tool; it is a Python library/module, not a system-level application.
...
Evidence:
- Static repository review completed on 2026-04-27.
- No static configuration or code for disabling non-essential capabilities is present; assessment requires runtime configuration and deployment context.
...
Evidence:
- Static repository review completed on 2026-04-27.
- No explicit port or protocol configuration is present in the repository; verification against PPSM CAL requires deployment and runtime configuration.
...
Evidence:
- Static repository review completed on 2026-04-27.
- No static evidence of reauthentication logic for privilege escalation or role change is present; this requires dynamic testing and configuration review.
...
Evidence:
- Static repository review completed on 2026-04-27.
- No device authentication or reauthentication logic is present in the static codebase; this control requires deployment and configuration validation.
...
Evidence:
- Static repository review completed on 2026-04-27.
- plugins/security_facet.py implements OAuth2/JWT-based authentication, requiring unique user tokens for access; see SecurityFacet and its use of verify_bearer and OIDC discovery.
...
Evidence:
- Static repository review completed on 2026-04-27.
- While plugins/security_facet.py supports OAuth2/JWT, there is no static evidence of multifactor (Alt. Token) enforcement for privileged accounts; requires runtime IdP and configuration validation.
...
Evidence:
- Static repository review completed on 2026-04-27.
- The code supports certificate-based authentication via OIDC/JWT, but explicit PIV/CAC credential acceptance is not statically verifiable; requires runtime IdP configuration and integration validation.
...
Evidence:
- Static repository review completed on 2026-04-27.
- Electronic verification of PIV credentials is not statically verifiable; OIDC/JWT support is present, but PIV-specific validation requires runtime IdP and deployment review.
...
Evidence:
- Static repository review completed on 2026-04-27.
- No static enforcement of multifactor authentication for non-privileged accounts is present; requires runtime IdP and configuration validation.
...
Evidence:
- Static repository review completed on 2026-04-27.
- No static enforcement of multifactor (Alt. Token) authentication for local privileged access is present; requires runtime and configuration validation.
...
Evidence:
- Static repository review completed on 2026-04-27.
- The security_facet.py file configures OAuth2/JWT and OIDC discovery, and the dependencies include PyJWT[crypto] and cryptography, which support strong authentication mechanisms.
- However, there is no explicit evidence of TLS enforcement or replay-resistant authentication for privileged accounts in the repository; runtime configuration and deployment validation are required.
...
- Static repository review completed on 2026-04-27.
- The security_facet.py file configures OAuth2/JWT and OIDC discovery, and the dependencies include PyJWT[crypto] and cryptography, which support strong authentication mechanisms.
- There is no explicit evidence of TLS enforcement or replay-resistant authentication for nonprivileged accounts in the repository; runtime configuration and deployment validation are required.
...
Evidence:
- Static repository review completed on 2026-04-27.
- The repository includes OIDC discovery and JWT validation logic in plugins/security_facet.py, but there is no static evidence of mutual authentication (e.g., CLIENT-CERT or two-way SSL/TLS) being enforced.
- Mutual authentication requirements and configuration must be validated at deployment and runtime.
...
Evidence:
- Static repository review completed on 2026-04-27.
- The application uses OAuth2/JWT for authentication (plugins/security_facet.py), but there is no static evidence of device authentication for all network-connected endpoints.
- The presence or absence of device authentication mechanisms must be validated at the system level.
...
Evidence:
- Static repository review completed on 2026-04-27.
- No static evidence of mutual SSL/TLS authentication for endpoint devices is present in the repository.
- Service-oriented architecture and non-releasable data handling must be confirmed in design and deployment documentation.
...
Evidence:
- Static repository review completed on 2026-04-27.
- There is no evidence in the repository of device identifier management or inactivity-based disabling logic.
- Device authentication and inactivity enforcement must be validated at the system and configuration level.
...
Evidence:
- Static repository review completed on 2026-04-27.
- No password-based authentication or password policy enforcement logic is present in the repository artifacts.
- If the application uses passwords, enforcement of minimum length must be validated at runtime or in configuration.
...
Evidence:
- Static repository review completed on 2026-04-27.
- No password-based authentication or password complexity enforcement logic is present in the repository artifacts.
- If the application uses passwords, enforcement of uppercase character requirement must be validated at runtime or in configuration.
...
- Static repository review completed on 2026-04-27.
- No password-based authentication or password complexity enforcement logic is present in the repository artifacts.
- If the application uses passwords, enforcement of lowercase character requirement must be validated at runtime or in configuration.
...
- Static repository review completed on 2026-04-27.
- No password-based authentication or password complexity enforcement logic is present in the repository artifacts.
- If the application uses passwords, enforcement of numeric character requirement must be validated at runtime or in configuration.
...
- Static repository review completed on 2026-04-27.
- No password-based authentication or password complexity enforcement logic is present in the repository artifacts.
- If the application uses passwords, enforcement of special character requirement must be validated at runtime or in configuration.
...
Evidence:
- Static repository review completed on 2026-04-27.
- No password-based authentication or password change logic is present in the repository artifacts.
- If the application uses passwords, enforcement of character change requirements must be validated at runtime or in configuration.
...
Evidence:
- Static repository review completed on 2026-04-27.
- No password storage logic is present in the repository artifacts.
- If the application uses passwords, cryptographic storage (hashing) must be validated in code or configuration.
...
Evidence:
- Static repository review completed on 2026-04-27.
- No password transmission logic is present in the repository artifacts.
- If the application uses passwords, cryptographic protection during transmission (e.g., TLS) must be validated at runtime or in configuration.
...
Evidence:
- Static repository review completed on 2026-04-27.
- No password-based authentication or password lifetime enforcement logic is present in the repository artifacts.
- If the application uses passwords, enforcement of minimum password lifetime must be validated at runtime or in configuration.
...
Evidence:
- Static repository review completed on 2026-04-27.
- No password-based authentication or password expiration logic is present in the repository artifacts.
- If the application uses passwords, enforcement of maximum password lifetime must be validated at runtime or in configuration.
...
Evidence:
- Static repository review completed on 2026-04-27.
- No password-based authentication or password reuse prevention logic is present in the repository artifacts.
- If the application uses passwords, enforcement of password history must be validated at runtime or in configuration.
...
Evidence:
- Static repository review completed on 2026-04-27.
- No password-based authentication or temporary password logic is present in the repository artifacts.
- If the application uses passwords, enforcement of temporary password change on first logon must be validated at runtime or in configuration.
...
Evidence:
- Static repository review completed on 2026-04-27.
- No certificate validation or PKI path construction logic is present in the provided source files.
- No evidence of certificate handling or trust anchor validation in the repository artifacts.
...
Evidence:
- Static repository review completed on 2026-04-27.
- No cryptographic private key storage or access control logic is present in the provided source files.
- No evidence of private key management or enforcement of access restrictions.
...
Evidence:
- Static repository review completed on 2026-04-27.
- No code mapping PKI-authenticated identities to user or group accounts is present in the provided source files.
- No evidence of certificate-to-user mapping or related logging.
...
Evidence:
- Static repository review completed on 2026-04-27.
- No implementation of certificate revocation list (CRL) caching or OCSP fallback is present in the provided source files.
- No evidence of revocation data handling or local cache logic.
...
Evidence:
- Static repository review completed on 2026-04-27.
- No password or PIN entry or display logic is present in the provided source files.
- No evidence of password/PIN obfuscation or clear text display handling.
...
Evidence:
- Static repository review completed on 2026-04-27.
- No cryptographic module authentication logic is present in the provided source files.
- No evidence of FIPS-validated cryptographic module enforcement or authentication.
...
Evidence:
- Static repository review completed on 2026-04-27.
- No authentication logic for non-organizational users is present in the provided source files.
- No evidence of unique identification or authentication for non-organizational users.
...
Evidence:
- Static repository review completed on 2026-04-27.
- No code handling Personal Identity Verification (PIV) credentials is present in the provided source files.
- No evidence of PIV credential acceptance or related configuration.
...
Evidence:
- Static repository review completed on 2026-04-27.
- No code handling electronic verification of PIV credentials is present in the provided source files.
- No evidence of PIV credential verification logic.
...
Evidence:
- Static repository review completed on 2026-04-27.
- No code handling FICAM-approved third-party credentials is present in the provided source files.
- No evidence of third-party credential acceptance or validation.
...
Evidence:
- Static repository review completed on 2026-04-27.
- No code referencing FICAM-issued profiles (e.g., SAML, OpenID) is present in the provided source files.
- No evidence of conformance to FICAM profiles.
...
Evidence:
- Static repository review completed on 2026-04-27.
- The application does not provide non-local maintenance or diagnostic session functionality based on the provided source files.
- No remote maintenance or diagnostic session code is present.
...
Evidence:
- Static repository review completed on 2026-04-27.
- No static analysis or code review evidence for race condition mitigation is present in the repository artifacts.
- No documentation or test results regarding race condition testing were found.
...
Evidence:
- Static repository review completed on 2026-04-27.
- The repository uses PyJWT[crypto] and cryptography for JWT signing/validation (see pyproject.toml dependencies), but there is no evidence of code signing for application components or explicit FIPS-validated module enforcement.
- No code or configuration for signing distributable application components was found.
- FIPS validation of cryptographic modules cannot be confirmed from static dependencies alone.
...
Evidence:
- Static repository review completed on 2026-04-27.
- The cryptography library is present (pyproject.toml), which can provide FIPS-compliant hashing if configured, but no explicit enforcement or configuration for FIPS-validated hash generation is present in the repository.
- No static evidence of hash generation or algorithm selection was found in the provided code.
- FIPS validation and algorithm selection require runtime and environment validation.
...
Evidence:
- Static repository review completed on 2026-04-27.
- The cryptography library is present (pyproject.toml), but there is no static evidence of FIPS-validated cryptographic module enforcement for protecting unclassified information.
- No code or configuration for encryption of unclassified data is present in the provided artifacts.
- FIPS validation and cryptographic protection require system-level and runtime validation.
...
Evidence:
- Static repository review completed on 2026-04-27.
- No evidence of SAML assertion generation or SAML SessionIndex handling was found in the repository.
- The application does not appear to implement SAML or related protocols; this control is not applicable to the current architecture.
...
Evidence:
- Static repository review completed on 2026-04-27.
- No code for HTTP session cookie creation or manipulation was found in the provided repository artifacts.
- No evidence of HTTPOnly flag setting on cookies is present in the static codebase.
- Requires review of web server/framework configuration and runtime behavior.
...
- Static repository review completed on 2026-04-27.
- No code for HTTP session cookie creation or manipulation was found in the provided repository artifacts.
- No evidence of Secure flag setting on cookies is present in the static codebase.
- Requires review of web server/framework configuration and runtime behavior.
...
Evidence:
- Static repository review completed on 2026-04-27.
- No code for session ID generation, transmission, or transport security (e.g., SSL/TLS enforcement) was found in the provided repository artifacts.
- No evidence of session ID protection in transit is present in the static codebase.
- Requires runtime validation and network traffic analysis.
...
Evidence:
- Static repository review completed on 2026-04-27.
- No code for session management, logoff handling, or cookie destruction was found in the provided repository artifacts.
- No evidence of session ID or cookie destruction on logoff or browser close is present in the static codebase.
- Requires review of web framework/session configuration and runtime behavior.
...
Evidence:
- Static repository review completed on 2026-04-27.
- No code for session ID generation or session fixation protection was found in the provided repository artifacts.
- No evidence of system-generated session identifiers or anti-fixation measures is present in the static codebase.
- Requires dynamic testing and review of session management implementation.
...
Evidence:
- Static repository review completed on 2026-04-27.
- No code for session identifier validation was found in the provided repository artifacts.
- No evidence of session ID validation logic is present in the static codebase.
- Requires review of session management implementation and runtime validation.
...
Evidence:
- Static repository review completed on 2026-04-27.
- No code for session ID generation or transmission via URL was found in the provided repository artifacts.
- No evidence of URL-embedded session IDs or explicit prevention thereof is present in the static codebase.
- Requires review of web framework/session configuration and runtime behavior.
...
Evidence:
- Static repository review completed on 2026-04-27.
- No code for session ID generation or reuse prevention was found in the provided repository artifacts.
- No evidence of session ID recycling or anti-reuse measures is present in the static codebase.
- Requires dynamic testing and review of session management implementation.
...
Evidence:
- Static repository review completed on 2026-04-27.
- No code for session identifier generation or random number generator selection was found in the provided repository artifacts.
- No evidence of FIPS 140-2/140-3 approved RNG usage for session IDs is present in the static codebase.
- Requires review of session management implementation and runtime configuration.
...
Evidence:
- Static repository review completed on 2026-04-27.
- No code or configuration for certificate authority selection or enforcement was found in the provided repository artifacts.
- No evidence of DoD-approved CA usage for protected session verification is present in the static codebase.
- Requires review of certificate configuration and runtime validation.
...
Evidence:
- Static repository review completed on 2026-04-27.
- No code or configuration for stored data confidentiality or integrity protection was found in the provided repository artifacts.
- No evidence of encryption or integrity controls for stored data is present in the static codebase.
- Requires review of data storage implementation and runtime configuration.
...
Evidence:
- Static repository review completed on 2026-04-27.
- No code or configuration for cryptographic mechanisms to prevent unauthorized modification of data at rest was found in the provided repository artifacts.
- No evidence of encryption or integrity controls for data at rest is present in the static codebase.
- Requires review of data storage implementation and runtime configuration.
...
Evidence:
- Static repository review completed on 2026-04-27.
- plugins/security_facet.py implements separation of security functions (authentication, token validation) from non-security functions via the SecurityFacet class and KBSpec registration.
- Security configuration and enforcement are isolated in the security module, with clear boundaries between security and application logic.
...
Evidence:
- Static repository review completed on 2026-04-27.
- No XML-based application code, XML parsers, or XML processing libraries are present in the supplied source or dependencies; the application is not XML-based.
...
Evidence:
- Static repository review completed on 2026-04-27.
- No XML-based web services, XML parsing, or XML processing functionality is present in the codebase or dependencies; the application does not process XML.
...
Evidence:
- Static repository review completed on 2026-04-27.
- No mobile code (e.g., JavaScript, ActiveX, Java applets) is present in the provided source code or dependencies.
- Application is a Python backend/library and does not deliver client-side executable code.
...
Evidence:
- Static repository review completed on 2026-04-27.
- .github/workflows/ci.yml defines a CI pipeline, but there is no evidence in the repository that the underlying CM repository host is patched or STIG compliant.
- No documentation or scripts for patch management or STIG application are present.
...
Evidence:
- Static repository review completed on 2026-04-27.
- No SCM plan or documentation describing configuration control, change management, or roles/responsibilities was found in the repository.
- No evidence of security classification labels, tool/version tracking, or change request tracking in code or config.
...
Evidence:
- Static repository review completed on 2026-04-27.
- No explicit evidence of IPv6 compatibility or readiness was found in the code or configuration files.
- Application dependencies (e.g., httpx, uvicorn) may support IPv6, but explicit configuration or testing is not present.
...
Evidence:
- Static repository review completed on 2026-04-27.
- security_facet.py and dependencies reference OAuth2/JWT and cryptographic modules (PyJWT[crypto], cryptography), but there is no explicit evidence of FIPS-140-2 validation or key exchange implementation details.
- No static evidence of key exchange encryption configuration.
...
Evidence:
- Static repository review completed on 2026-04-27.
- No embedded authentication data, passwords, or secrets were found in the provided source code or configuration files.
- Sensitive values (e.g., INTROSPECTION_CLIENT_SECRET) are explicitly documented to be loaded from environment variables, not hardcoded.
...
Evidence:
- Static repository review completed on 2026-04-27.
- No evidence of output marking for sensitive/classified data was found in the codebase.
- No classification guide or marking logic is present in the repository.
...
Evidence:
- Static repository review completed on 2026-04-27.
- .github/workflows/ci.yml defines automated test execution, but there is no evidence of formal test plans or procedures being created and updated for each release.
- No test plan documentation or release-specific test artifacts found.
...
Evidence:
- Static repository review completed on 2026-04-27.
- No evidence of cryptographic hash validation of application files prior to deployment was found in the repository.
- No scripts or documentation describing a hash validation process are present.
...
Evidence:
- Static repository review completed on 2026-04-27.
- No evidence of designated security testers or organizational chart was found in the repository.
- No documentation of security testing roles or assignments present.
...
Evidence:
- Static repository review completed on 2026-04-27.
- No documentation or scripts describing annual test procedures for secure initialization, shutdown, or aborts were found.
- No evidence of test execution dates or results for these scenarios.
...
Evidence:
- Static repository review completed on 2026-04-27.
- .github/workflows/ci.yml runs automated tests, but there is no evidence of formal code review processes or reports targeting security flaws.
- No documentation or artifacts of code review for security issues found.
...
Evidence:
- Static repository review completed on 2026-04-27.
- [tool.coverage.run] and [tool.coverage.report] sections in pyproject.toml configure code coverage collection and reporting for each release.
- Coverage data is stored in .coverage/coverage and HTML reports are generated, demonstrating code coverage statistics are maintained.
...
Evidence:
- Static repository review completed on 2026-04-27.
- [tool.ruff] and [tool.pyright] sections in pyproject.toml define linting and type checking standards, but no explicit coding standards document was found.
- Evidence of automated code quality enforcement exists, but developer adherence to a formal coding standard cannot be confirmed from repository artifacts alone.
...
Evidence:
- Static repository review completed on 2026-04-27.
- [tool.ruff.lint.select] in pyproject.toml enables flake8-bandit (S), flake8-blind-except (BLE), and other error handling/security checks.
- Error handling vulnerabilities are actively scanned for in the codebase via static analysis tools.
...
Evidence:
- Static repository review completed on 2026-04-27.
- No evidence found that the application processes classified information; this control is not applicable to the current application context.
...
Evidence:
- Static repository review completed on 2026-04-27.
- The application uses the 'cryptography' and 'PyJWT[crypto]' libraries (see pyproject.toml), which are capable of supporting NSA-approved algorithms, but no evidence of classified data handling or explicit NSA-approved cryptography enforcement is present in the repository.
- No static evidence of classified data processing or configuration for NSA-approved cryptography was found in the supplied source code.
- Control-specific implementation evidence was not demonstrably satisfied from repository artifacts alone; disposition set to Open pending system-level validation and artifact collection.
